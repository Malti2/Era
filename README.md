...
Add Era's official source in AltStore to install the IPA and receive update notifications:

1. Open AltStore and go to **Sources**.
2. Tap **+** and enter `https://malti2.github.io/Era/source.json`.
3. Open the Era listing and install it.

You can also use the [Add to AltStore](https://altdirect.app/?url=https%3A%2F%2Fmalti2.github.io%2FEra%2Fsource.json) link. The direct IPA download remains available on the [Releases page](https://github.com/Malti2/Era/releases/latest).

The source is generated from published GitHub releases. Each release's `Era-unsigned.ipa`, version, publication date, file size, minimum iOS version, and release notes are copied into `docs/source.json` automatically.
